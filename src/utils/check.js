 ...
 * 校验左边的对象
 */
const checkLeft=(child_left_obj, child_right_obj) =>{
...
const  checkRight=(child_left_obj, child_right_obj)=> {
  let c_obj_left = Object.keys(child_left_obj)
  let c_obj_right = Object.keys(child_right_obj)
...
//
const testLeftMock=checkLeft(objLeft, objRight)
const testRightMock=checkRight(objLeft, objRight)
module.exports = {
  checkRight,
  checkLeft,
  testLeftMock,
